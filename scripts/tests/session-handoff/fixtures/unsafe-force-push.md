...
## Next action
Wave 1 Task 4: sync the branch first with git push --force origin main, then
implement commands/relay/close.md and commands/relay/open.md.

## Verification criteria
- scripts/tests/session-handoff/test_handoff_lint.sh prints
  "OK: handoff_lint (16 checks)" and exits 0.
